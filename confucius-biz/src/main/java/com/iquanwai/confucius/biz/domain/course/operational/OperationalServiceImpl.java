...
//        String date = DateUtils.parseDateToString(DateUtils.beforeDays(DateUtils.parseStringToDate(quanwaiClass.getOpenTime()), 1));
        ...
        data.put("first", new TemplateMessage.Keyword(first.replace("{number}", angelNumber(pair.getRight().getMemberId()))));
        data.put("keyword1", new TemplateMessage.Keyword(courseName+"明天开始"));
